...
```bash
# Check your work
learn check ex30-rwlock-protocol

# Get a hint if stuck
learn hint ex30-rwlock-protocol

# Jump to a specific hint level
learn hint ex30-rwlock-protocol --level 2
```
...
Complete this quest to unlock **Parallel Ops Capstone** (ex31), the World 6 finale combining all concurrency tools in one pipeline.
