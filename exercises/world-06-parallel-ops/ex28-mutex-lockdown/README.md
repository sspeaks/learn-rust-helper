...
```bash
# Check your work
learn check ex28-mutex-lockdown

# Get a hint if stuck
learn hint ex28-mutex-lockdown

# Jump to a specific hint level
learn hint ex28-mutex-lockdown --level 2
```
...
Complete this quest to unlock **Sensor Array** (ex29), where you'll use rayon to process data in parallel without managing threads manually.
