...
```bash
# Check your work
learn check ex27-cargo-channel

# Get a hint if stuck
learn hint ex27-cargo-channel

# Jump to a specific hint level
learn hint ex27-cargo-channel --level 2
```
...
Complete this quest to unlock **Mutex Lockdown** (ex28), where multiple threads share and mutate a single piece of state safely.
