...
```bash
# Check your work
learn check ex26-crew-dispatch

# Get a hint if stuck
learn hint ex26-crew-dispatch

# Jump to a specific hint level
learn hint ex26-crew-dispatch --level 2
```
...
Complete **Deep Signal Capstone** (ex25).
...
Complete this quest to unlock **Cargo Channel** (ex27), where threads communicate through channels rather than being joined directly.
