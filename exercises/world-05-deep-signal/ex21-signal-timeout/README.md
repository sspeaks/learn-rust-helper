...
```bash
# Check your work
learn check ex21-signal-timeout

# Get a hint if stuck
learn hint ex21-signal-timeout

# Jump to a specific hint level
learn hint ex21-signal-timeout --level 2
```
...
Complete this quest to unlock **Relay Dispatch** (ex22), where you'll send data outbound via HTTP POST.
