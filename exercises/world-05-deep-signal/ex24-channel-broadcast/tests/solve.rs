...
async fn fetch_single_receipt_success() {
    ...
    let receipt = async_call_or_hint!("ex24", "fetch_broadcast_receipt", {
...
async fn fetch_invalid_status_includes_channel_context() {
    ...
    let base_url = server.uri();
    let result = async_call_or_hint!("ex24", "fetch_broadcast_receipt", {
        let base_url = base_url.clone();
...
async fn broadcast_empty_targets_returns_empty_vec() {
    let result = async_call_or_hint!("ex24", "broadcast_channels", {
...
async fn broadcast_single_target_success() {
    ...
    let base_url = server.uri();
    let receipts = async_call_or_hint!("ex24", "broadcast_channels", {
        let base_url = base_url.clone();
