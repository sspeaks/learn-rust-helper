use ex19_beacon_ping::{ping_beacon, BeaconPingError};
...
fn ping_success_returns_endpoint_status_and_body() {
    ...
    let ping = call_or_hint!("ex19", "ping_beacon", ping_beacon(&base_url, "alpha-7"))
...
fn ping_handles_not_found_as_request_error() {
    ...
    let base_url = server.uri();
    let result = call_or_hint!("ex19", "ping_beacon", ping_beacon(&base_url, "missing"));
...
fn ping_handles_server_error_as_request_error() {
    ...
    let base_url = server.uri();
    let result = call_or_hint!("ex19", "ping_beacon", ping_beacon(&base_url, "unstable"));
...
fn ping_invalid_utf8_body_maps_to_read_body_error() {
    ...
    let base_url = server.uri();
    let result = call_or_hint!("ex19", "ping_beacon", ping_beacon(&base_url, "raw"));
...
fn ping_supports_empty_204_response_body() {
    ...
    let base_url = server.uri();
    let ping = call_or_hint!("ex19", "ping_beacon", ping_beacon(&base_url, "empty"))
...
fn ping_preserves_multiline_body_text() {
    ...
    let base_url = server.uri();
    let ping = call_or_hint!("ex19", "ping_beacon", ping_beacon(&base_url, "logs"))
...
fn ping_allows_alphanumeric_beacon_ids() {
    ...
    let base_url = server.uri();
    let ping = call_or_hint!("ex19", "ping_beacon", ping_beacon(&base_url, "BETA42"))
