...
```bash
# Check your work
learn check ex34-mission-ledger

# Get a hint if stuck
learn hint ex34-mission-ledger

# Jump to a specific hint level
learn hint ex34-mission-ledger --level 2
```
...
Complete this quest to unlock **Archive Query** (ex35), where you'll filter and retrieve records with parameterized WHERE clauses.
