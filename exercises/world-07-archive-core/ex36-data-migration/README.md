...
```bash
# Check your work
learn check ex36-data-migration

# Get a hint if stuck
learn hint ex36-data-migration

# Jump to a specific hint level
learn hint ex36-data-migration --level 2
```
...
Complete this quest to unlock **Archive Capstone** (ex37), the World 7 finale combining async HTTP with synchronous SQLite persistence.
