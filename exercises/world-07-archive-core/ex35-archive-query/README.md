...
```bash
# Check your work
learn check ex35-archive-query

# Get a hint if stuck
learn hint ex35-archive-query

# Jump to a specific hint level
learn hint ex35-archive-query --level 2
```
...
Complete this quest to unlock **Data Migration** (ex36), where you'll evolve the schema with incremental ALTER TABLE migrations.
