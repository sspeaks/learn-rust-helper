...
```bash
# Check your work
learn check ex33-crew-manifest

# Get a hint if stuck
learn hint ex33-crew-manifest

# Jump to a specific hint level
learn hint ex33-crew-manifest --level 2
```
...
Complete **Schema Bootstrap** (ex32).
...
Complete this quest to unlock **Mission Ledger** (ex34), where you'll apply database transactions and enforce business rules.
