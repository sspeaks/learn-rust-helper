...
```bash
# Check your work
learn check ex17-packet-decode

# Get a hint if stuck
learn hint ex17-packet-decode

# Jump to a specific hint level
learn hint ex17-packet-decode --level 2
```
...
Complete this quest to unlock **Signal Timeout** (ex18), where you'll configure timeouts and map the full spectrum of HTTP errors.
