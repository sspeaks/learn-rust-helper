use ex17_packet_decode::{decode_packet, decode_packet_batch, Packet, PacketDecodeError};
...
fn decode_packet_parses_valid_payload() {
    ...
    let packet = call_or_hint!("ex17", "decode_packet", decode_packet(payload))
...
fn decode_packet_rejects_empty_packet_id() {
    ...
    let result = call_or_hint!("ex17", "decode_packet", decode_packet(payload));
...
fn decode_packet_reports_invalid_json() {
    let result = call_or_hint!("ex17", "decode_packet", decode_packet("{not-json}"));
...
fn decode_packet_batch_empty_input_returns_empty_vec() {
    let decoded = call_or_hint!("ex17", "decode_packet_batch", decode_packet_batch(&[]))
...
fn decode_packet_batch_preserves_input_order() {
    ...
    let decoded = call_or_hint!("ex17", "decode_packet_batch", decode_packet_batch(&inputs))
...
fn decode_packet_batch_stops_on_first_error() {
    ...
    let result = call_or_hint!("ex17", "decode_packet_batch", decode_packet_batch(&inputs));
