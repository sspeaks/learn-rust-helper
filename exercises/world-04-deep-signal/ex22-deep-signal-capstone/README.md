# Quest 22: Deep Signal Capstone

**🎮 Quest:** The sector network is live, async, and broadcasting. Now the Admiral wants a full health report: query every node in the fleet, classify which are healthy vs. degraded, and compute the average signal strength—all in one pipeline. This is World 4's capstone.
...
```bash
# Check your work
learn check ex22-deep-signal-capstone

# Get a hint if stuck
learn hint ex22-deep-signal-capstone

# Jump to a specific hint level
learn hint ex22-deep-signal-capstone --level 2
```
...
Complete **Channel Broadcast** (ex21).
...
**Congratulations!** You've mastered World 4: Deep Signal. You now know:
...
Continue to **World 5: Parallel Ops** for threads, channels, and shared mutable state.

---

**World 4 XP:** 2,800 | **Rank at this point:** Vanguard ✦ (3,500+ XP cumulative)
