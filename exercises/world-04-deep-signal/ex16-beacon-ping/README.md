...
```bash
# Check your work
learn check ex16-beacon-ping

# Get a hint if stuck
learn hint ex16-beacon-ping

# Jump to a specific hint level
learn hint ex16-beacon-ping --level 2
```
...
Complete this quest to unlock **Packet Decode** (ex17), where you'll deserialize the JSON payloads arriving over those beacon connections.
