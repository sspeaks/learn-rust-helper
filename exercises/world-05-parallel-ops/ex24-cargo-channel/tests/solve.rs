use ex24_cargo_channel::{dispatch_cargo_jobs, CargoJob, CargoReceipt};
...
fn empty_jobs_return_empty_receipts() {
    let receipts = call_or_hint!("ex24", "dispatch_cargo_jobs", dispatch_cargo_jobs(vec![]))
...
fn multiple_jobs_preserve_submission_order() {
    ...
    let receipts = call_or_hint!("ex24", "dispatch_cargo_jobs", dispatch_cargo_jobs(jobs))
...
fn repeated_runs_return_same_receipts() {
    ...
    let second = call_or_hint!("ex24", "dispatch_cargo_jobs", dispatch_cargo_jobs(jobs))
