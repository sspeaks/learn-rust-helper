...
- **Data parallelism vs. task parallelism:** Rayon processes a uniform operation over all elements; ex23-ex25 dispatched heterogeneous tasks.
...
```bash
# Check your work
learn check ex26-sensor-array

# Get a hint if stuck
learn hint ex26-sensor-array

# Jump to a specific hint level
learn hint ex26-sensor-array --level 2
```
...
Complete this quest to unlock **RwLock Protocol** (ex27), where you'll optimize read-heavy shared state with a read-write lock.
