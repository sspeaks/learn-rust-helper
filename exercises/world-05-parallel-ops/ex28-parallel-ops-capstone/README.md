# Quest 28: Parallel Ops Capstone
...
```bash
# Check your work
learn check ex28-parallel-ops-capstone

# Get a hint if stuck
learn hint ex28-parallel-ops-capstone

# Jump to a specific hint level
learn hint ex28-parallel-ops-capstone --level 2
```
...
**Congratulations!** You've mastered World 5: Parallel Ops. You can now:
...
Continue to **World 6: Archive Core** for persistent storage with SQLite.

---

**World 5 XP:** 2,560 | **Rank at this point:** Admiral ⬡ (5,500+ XP cumulative)
